            ...
            <div className="experience-list">
              <article className="experience-item">
                ...
                <ul className="experience-bullets">
                  <li>Expand professional network by engaging with 10+ industry professionals and alumni through structured mentorship and targeted career workshops</li>
                  <li>Organize and participate in academic and social development activities, fostering peer support, accountability, and cross-disciplinary collaboration among 33 students</li>
                  <li>Facilitate community engagement by partnering with 10+ campus organizations to plan and execute service initiatives impacting the greater Gainesville community</li>
                </ul>
              </article>
              ...
              <article className="experience-item">
                ...
                <ul className="experience-bullets">
                  <li>Managed and grew YMCA social media accounts by creating engaging posts and promoting programs and community initiatives</li>
                  <li>Planned and coordinated events to increase member engagement and community involvement</li>
                  <li>Collaborated with staff to develop marketing strategies and ensure consistent branding across digital and in-person outreach</li>
                </ul>
              </article>
              ...
              <article className="experience-item">
                ...
                <p className="experience-location">Gainesville, FL</p>
                <ul className="experience-bullets">
                  <li>Learning the fundamentals of embedded systems and microcontroller programming for sensor data collection and telemetry</li>
                  <li>Gaining experience with circuit design, soldering, and integrating sensors such as GPS, accelerometers, and pressure sensors into the CanSat payload</li>
                  <li>Exploring wireless communication and firmware development to understand how real-time data is transmitted between the CanSat and the ground station</li>
                </ul>
              </article>
            </div>
          </div>
